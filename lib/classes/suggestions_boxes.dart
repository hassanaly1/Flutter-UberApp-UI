...
import 'package:kwike/screens/user/home/User/kwike_feeds/kwike_feeds_screen.dart';
import 'package:kwike/screens/user/services/booking_rides.dart';
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          SingleSuggestionBox(
              onTap: () => Get.to(const KwikeFeedsScreen(),
                  transition: Transition.downToUp),
              imagePath: 'assets/images/dining-icon.svg',
              suggestionBoxText: 'KWIK-E Feeds'),
          SingleSuggestionBox(
              onTap: () {},
